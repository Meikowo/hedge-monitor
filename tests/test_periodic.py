...
class PeriodicNormalizationTest(unittest.TestCase):
    ...
    def test_periodic_locator_report_ids_bypass_status_filter(self):
        ...
        self.assertEqual(params["report_id"], "in.(r1,r2)")
        self.assertNotIn("status", params)
...
class PeriodicValidationBatchTest(unittest.TestCase):
    ...
    def test_workflow_defaults_to_validation_batch_and_scopes_all_stages(self):
        ...
        self.assertEqual(commands.count('--sample "$SAMPLE_FILE"'), 5)
    ...
    def test_workflow_has_safe_scheduled_batches(self):
        ...
        self.assertEqual(schedule, [{"cron": "45 22,4,10,16 * * *"}])
        ...
        self.assertIn("config/annual_priority_2025.csv", job["env"]["SAMPLE_FILE"])
        self.assertIn(
            'locate_periodic_pages.py --sample "$SAMPLE_FILE" --fiscal-year 2025 --report-type annual --limit 12 --write',
            commands,
        )
        self.assertIn(
            'extract_periodic_reports.py --sample "$SAMPLE_FILE" --fiscal-year 2025 --report-type annual --limit 6 --confirm-llm',
            commands,
        )
